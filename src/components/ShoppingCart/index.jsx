        ...
        <>
            <HyperModal isOpen={isModalOpen} requestClose={() => setIsModalOpen(false)}>
                <div className="w-full h-full flex flex-col justify-between items-center pt-[3rem] pb-[2rem]">
                    <p className="font-[AmazonBold] text-[18px]">The order was successfully placed.</p>
                    <div className="w-[40%] flex justify-center items-center">
                        <Button className="w-[100px] h-[50px] rounded-[.5rem] text-[22px] font-[Lato] bg-[#035972] text-white" onClick={() => setIsModalOpen(false)}>close</Button>
                    </div>
                </div>
            </HyperModal>
                ...
                <div className="w-full h-full bg-[#EDEDED] flex flex-row p-[1rem] gap-[1rem]">
                    ...
                    <div className="w-[440px] h-[265px] bg-white rounded-[1rem] flex flex-col p-[1.5rem] gap-[.8rem] font-[AmazonLight]">
                        ...
                        <div className="w-full flex justify-center items-center ">
                            <button disabled={orderlist.length === 0 ? true : false} className="w-full h-[50px] flex justify-center items-center gap-3 pl-[.5rem] pr-[.5rem] bg-[#035972] rounded-[.5rem] text-white font-[AmazonLight] text-[22px] disabled:bg-[#EDEDED] disabled:text-[#545460]" onClick={()=>{
